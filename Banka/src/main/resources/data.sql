insert into customer (id, merchant_id, merchant_password, first_name, last_name) values (1, 'milica', 'milica', 'Milica', 'Makaric');
insert into customer (id, merchant_id, merchant_password, first_name, last_name) values (2, 'taca', 'taca', 'Tamara', 'Makaric');
